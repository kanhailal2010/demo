            ...
            if(!$bundle){
              echo '<div class="bullie-wrap">';
                echo '<div class="bullie">';
                  ...
                  echo '<div class="upgrade">' . __('Start a 14 day Free trial of our Entrepreneur Bundle to try out all of our CRM extensions.', 'zero-bs-crm') . '</div>';
                  echo '<a class = "ui button green mini upgrade-bullie-box" href="'. $zbs->urls['upgrade'].'" target = "_blank"><i class="cart plus icon"></i> ' . __('Start Trial', 'zero-bs-crm') . '</a>';
                echo '</div>';
              echo '</div>';
          ...
          echo '<div class="zbs-page-wrap">';
            ...
            echo '<div class="bullie-wrap">';
              echo '<div class="bullie">';
                ...
                echo '<div class="upgrade">' . __('Start a 14 day Free trial of our Entrepreneur Bundle to try out all of our CRM extensions.', 'zero-bs-crm') . '</div>';
                echo '<a class = "ui button green mini upgrade-bullie-box" href="'.$zbs->urls['upgrade'] .'" target = "_blank"><i class="cart plus icon"></i> ' . __('Start Free Trial Now', 'zero-bs-crm') . '</a>';
              echo '</div>';
            echo '</div>';
            echo '<div class="clear"></div>';
            }  
