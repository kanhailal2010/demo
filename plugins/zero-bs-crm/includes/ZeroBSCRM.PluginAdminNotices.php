...
function jpcrm_woo_promo_admin_notice_banner(){
    ...
    ?>
        <div id="woo-promo" class="ui segment jpcrm-promo notice is-dismissible">
            <div class="content">
                <b><?= __('14 day free trial of WooCommerce Connect!', 'zero-bs-crm' ) ?></b>
                <br><?= __('Sync your WooCommerce purchases to Jetpack CRM and continue to nurture your new customers.', 'zero-bs-crm') ?>
            </div>
            <div class="button-group">
                <a href="https://jetpackcrm.com/checkout/?plan=woosync&utm_source=core_plugin&utm_medium=plugin&utm_campaign=woofreetrial" target="_blank;" class="button ui green"><?php _e("Get Started for free","zero-bs-crm");?></a>
